...
import { IoIosArrowBack, IoIosArrowForward } from "react-icons/io";
    ...
    stories: [
      {
        ...
        description: "Mô tả ngắn Truyện Hot 1",
      },
      {
        _id: "2",
        slug: "truyen-hot-2",
        ...
        description: "Mô tả ngắn Truyện Hot 2",
      },
    ],
  };
    ...
    stories: [
      {
        ...
        totalChapters: 10,
        createdAt: "2025-12-28",
        description: "Mô tả ngắn Truyện Mới 1",
      },
      {
        _id: "4",
        slug: "truyen-moi-2",
        ...
        totalChapters: 5,
        createdAt: "2025-12-28",
        description: "Mô tả ngắn Truyện Mới 2",
      },
    ],
  };
  ...
  const recommendStories = {
    stories: [
      {
        _id: "5",
        slug: "truyen-de-xuat-1",
        title: "Truyện Đề Xuất 1",
        viewsCount: 500,
        followsCount: 120,
        totalChapters: 20,
        createdAt: "2025-12-25",
        description: "Mô tả ngắn Truyện Đề Xuất 1",
      },
      {
        _id: "6",
        slug: "truyen-de-xuat-2",
        title: "Truyện Đề Xuất 2",
        viewsCount: 400,
        followsCount: 80,
        totalChapters: 15,
        createdAt: "2025-12-26",
        description: "Mô tả ngắn Truyện Đề Xuất 2",
      },
    ],
  };
  // =====================

  // Hàm mock format ngày
  const formatTimeVN = (date: string) => date;
