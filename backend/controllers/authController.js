...
import { RefreshTokenService, SignInService, SignOutService, SignUpService } from "../services/authService.js";
...
export const SignIn = async (req, res, next) => {
    try {
        ...
        res.status(200).json({ message: `User ${user.displayName} đã đăng nhập thành công` });
    } catch (err) {
        next(err);
    }
};
